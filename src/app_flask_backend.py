...
def process_images():
    ...
    predefined_locations_csv = request.json['predefined_locations_csv']
    ...
    if not os.path.isfile(predefined_locations_csv):
        raise Exception("Invalid predefined locations CSV file.")
    else:
            ...
            if exif_data is not None and 34853 in exif_data:
                ...
                if closest_location is not None:
                    selected_images.append({
                        ...
                        'original_lat': closest_location['latitude'],
                        'original_lon': closest_location['longitude']
                    })
