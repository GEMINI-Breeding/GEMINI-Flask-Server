...
def process_directories_in_parallel_from_db(dir_index, base_dir, max_depth=2):
    """Process directories using DirectoryIndex database (synchronous version)"""
    ...
    for d in directories:
        structure = build_nested_structure_sync_from_db(dir_index, d, 0, max_depth)
        combined_structure[d.name] = structure
    return combined_structure
